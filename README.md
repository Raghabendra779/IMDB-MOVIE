...
1. Home Page:
     On this page, Users can search for any movie using the OMDB API.
...
2. My Favourite Movies Page:
     ...
     By means of this page users can get UI to access and manipulate their favourite movies. Users can view a list of all their favourite movies on 
     this page.
